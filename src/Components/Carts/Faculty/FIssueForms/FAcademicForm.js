            ...
            <div className="container py-4">
              <Form onSubmit={handleSubmit}>
                <Row className='mb-3'>
                  ...
                  <Col>
                    <div className='text-start'>
                      ...
                      <Form.Control type="text" id="email" name="email" placeholder='Ex: john987@gmail.com' value={formData.email} onChange={handleChange} isInvalid={!!errors.email} />
                ...
                <Row className='mb-3'>
                  <Col>
                    <div className='text-start'>
                      ...
                      <Form.Control type="text" id="description" name="description" placeholder='Describe in Detail' value={formData.description} onChange={handleChange} isInvalid={!!errors.description} />
                      <Form.Control.Feedback type="invalid">{errors.description}</Form.Control.Feedback>
                    </div>
                  </Col>
                  <Col>
                    <div className='text-start'>
                      <Form.Label htmlFor="count" className="form-label">Status(Please select pending)<span style={{ color: 'red' }}>*</span></Form.Label>
                ...
                <Row className='mb-3'>
                  ...
                  <Col>
                    <div className='text-start'>
                      ...
                      <Form.Control type="date" id="prt" name="prt" value={formData.prt} placeholder='Select date' onChange={handleChange} isInvalid={!!errors.prt} />
                ...
                <Row className='mb-3'>
                  ...
                  <Col>
                    <div className='text-start'>
                      <Form.Label htmlFor="fileInput" className="form-label">Attachments<span style={{ color: 'red' }}>*</span></Form.Label>
                      <Form.Control type="file" id="fileInput" name="fileInput" value={formData.fileInput} placeholder='Add Attachments' onChange={handleChange} isInvalid={!!errors.fileInput} />
...
function FacultyAcademicReportForm() {
...
export default FacultyAcademicReportForm;
